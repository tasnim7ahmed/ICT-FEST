    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item"><a href="../snipp/about.html" class="nav-link">About</a></li>
          <li class="nav-item"><a href="../snipp/services.html" class="nav-link">Services</a></li>
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="../snipp/portfolio.html" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Portfolio</a>
              <div class="dropdown-menu" aria-labelledby="dropdown04">
                <a class="dropdown-item" href="../snipp/portfolio.html">Portfolio</a>
                <a class="dropdown-item" href="../snipp/portfolio-single.html">Portfolio Single</a>
              </div>
          </li>
          <li class="nav-item"><a href="../snipp/blog.html" class="nav-link">Case Studies</a></li>
          <li class="nav-item"><a href="../snipp/contact.html" class="nav-link">Contact</a></li>
          <li class="nav-item cta"><a href="../snipp/contact.html" class="nav-link"><span>Get in touch</span></a></li>
        </ul>
      </div>
    </div>
  </nav>
