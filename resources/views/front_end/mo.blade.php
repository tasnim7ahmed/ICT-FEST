    ...
    <div class="row justify-content-center mb-5 pb-5">
      <div class="col-md-6 text heading-section ftco-animate">
        ...
        <ul>
          ...
          <li>
            <h5 style="color: red">University Level: 410 Taka (Four Hundred Taka)</h4>
          </li>
          <li>
            <h5 style="color: red">School/College Level: 310 Taka (Three Hundred Taka)</h4>
          </li>
        ...
        <p>
        <h5 style="color: black">For further query contact, Fahim Shahriar Shakkhor: +8801733065177</h5>
        </p>
        <p>&nbsp;</p>
      </div>
    </div>
