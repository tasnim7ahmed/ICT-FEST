          ...
          <div class="col-md-6 col-lg-4 d-flex align-self-stretch ftco-animate">
            ...
            <a href="{{route('mo')}}">
              ...
              <div class="media-body p-2 mt-3">
                ...
                <p style="color: black">Is crunching large numerical datasets your forte? Or maybe, solving unsolvable equations is your jam? Either way, our Math Olympiad is the perfect opportunity to get your analytical juices flowing. Register now!</p>
              </div>
            </a>
            </div>      
          </div>
          <div class="col-md-6 col-lg-4 d-flex align-self-stretch ftco-animate">
            ...
            <a href="{{route('io')}}">
              ...
              <div class="media-body p-2 mt-3">
                ...
                <p style="color: black">Think you know the ins and outs of the latest technological advances out there? Prove yourself in our cleverly designed ICT Olympiad and win it big!</p>
              </div>
            </a>
            </div>      
          </div>
          <div class="col-md-6 col-lg-4 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                ...
                <p style="color: black">Speed or accuracy? Hasty start or steady finish? If you have what it takes to make the right decisions in the right scenarios, register now with your team to show that your analytical prowess is above and beyond your peers!</p>
              </div>
            </div>    
          </div>
          ...
          <div class="col-md-6 col-lg-4 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                ...
                <p style="color: black">Brimming with ideas but lack the proper podium to present your ideas and articulate your thoughts? We have just the place where you can showcase your project and turn heads in the process! Register now and prove your worth!</p>
              </div>
            </div>    
          </div>
          ...
          <div class="col-md-6 col-lg-4 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                ...
                <p style="color: black">Have a ground-breaking idea that can potentially improve the lives of millions? Is so, this is your opportunity to showcase your talents and ideas in the right platform, in front of the right people. Register now and unleash your inner genie!</p>
              </div>
            </div>    
          </div>
          ...
          <div class="col-md-6 col-lg-4 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                ...
                <p style="color: black">To all the technology enthusiasts out there, it’s your time to shine! Grab all of your creative ideas and thoughts about our today’s technology, and present them with stunning posters. Share your creativity with us and win amazing cash prizes!</p>
              </div>
            </div>    
          </div>
          ...
          <div class="col-md-6 col-lg-4 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                ...
                <p style="color: black">Do you have a knack for scoring exceptional goals against the toughest defenses? Register now!</p>
              </div>
            </div>    
          </div>
          ...
          <div class="col-md-6 col-lg-4 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                ...
                <p style="color: black">Do you think your precision aim and quick thinking can successfully defuse bombs in hostile situations? Register now to find out!</p>
              </div>
            </div>    
          </div>
          ...
          <div class="col-md-6 col-lg-4 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                ...
                <p style="color: black">Your phenomenal carry or support gameplay can lead your team to a glorious victory. In any case, our gaming fest gives you the opportunity to accomplish all this and more! Register now!
</p>
              </div>
            </div>    
          </div>
          ...
          <div class="col-md-6 col-lg-6 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                ...
                <p style="color: black">If you have what it takes to transform abstract ideas into truly innovational breakthroughs, then our “App Development” event is made for you. Register now and show everyone that your development skills are second to none!</p>
              </div>
            </div>    
          </div>
          ...
          <div class="col-md-6 col-lg-6 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                ...
                <p style="color: black">Brainstorm your way through seemingly impossible difficulties and hurdles and show the world that every problem has a solution when there’s creativity and the will to achieve success. Registration for hackathon is now live!</p>
              </div>
            </div>    
          </div>
