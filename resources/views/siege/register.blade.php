...
<div class="right_col" role="main">
	<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h1>RAINBOW SIX SIEGE / <small>register a new team</small></h1>
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="{{ route('store_siege') }}">
                    	{{ csrf_field() }}
                 ...
                 <div class="col-md-12 mb-4">
                      ...
                      <div class="form-group col-md-4 col-sm-6 col-xs-12">
                          <input type="text" name="member_1_ign" class="form-control" placeholder="In-Game Name (IGN) of the Team Leader">
                      </div>
                      ...
                      <div class="form-group col-md-4 col-sm-6 col-xs-12">
                          <input type="text" name="member_2_ign" class="form-control" placeholder="In-Game Name (IGN) of Member - 1">
                      </div>
                      ...
                      <div class="form-group col-md-4 col-sm-6 col-xs-12">
                          <input type="text" name="member_3_ign" class="form-control" placeholder="In-Game Name (IGN) of Member - 2">
                      </div>
                      ...
                      <div class="form-group col-md-4 col-sm-6 col-xs-12">
                          <input type="text" name="member_4_ign" class="form-control" placeholder="In-Game Name (IGN) of Member - 3">
                      </div>
                      ...
                      <div class="form-group col-md-4 col-sm-6 col-xs-12">
                          <input type="text" name="member_5_ign" class="form-control" placeholder="In-Game Name (IGN) of Member - 4">
                      </div>
