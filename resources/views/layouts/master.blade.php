            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i>Hackathon<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href={{route('register_hackathon')}}>Register</a></li>
                      <li><a href={{route('hackathon_list')}}>Participants' Info</a></li>
                    </ul>
                  </li>
